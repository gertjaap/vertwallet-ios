...
class StartImportViewController : UIViewController {
    ...
    private let header = RadialGradientView(backgroundColor: UIColor.gradientStart, offset: 64.0)
    ...
    private func addConstraints() {
        ...
        illustration.constrain([
            ...
            illustration.constraint(.centerY, toView: header, constant: C.padding[2]) ])
